<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckOut.aspx.cs" Inherits="ECOmerce.CheckOut" MasterPageFile="~/Site1.Master" %>
                ...
                <table class="timetable_sub">
                    ...
                    <tr class="rem1">
                        ...
                        <td class="invert-image"><a href="single.html">
                            <img src="images/22.jpg" alt=" " class="img-responsive" /></a></td>
                        <td class="invert">
                            <div class="quantity">
        ...
        $('.rem1').fadeOut('slow', function (c) {
            $('.rem1').remove();
                    ...
                    <tr class="rem2">
                        ...
                        <td class="invert-image"><a href="single.html">
                            <img src="images/30.jpg" alt=" " class="img-responsive" /></a></td>
                        <td class="invert">
                            <div class="quantity">
                                <div class="quantity-select">
                                    <div class="entry value-minus">&nbsp;</div>
        ...
        $('.rem2').fadeOut('slow', function (c) {
            $('.rem2').remove();
                    ...
                    <tr class="rem3">
                        ...
                        <td class="invert-image"><a href="single.html">
                            <img src="images/11.jpg" alt=" " class="img-responsive" /></a></td>
                        <td class="invert">
                            <div class="quantity">
                                <div class="quantity-select">
                                    <div class="entry value-minus">&nbsp;</div>
